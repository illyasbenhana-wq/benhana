    ...
    <div id="ethofi-screen" style={{ minHeight: '100vh', background: C.background, color: C.textPrimary, fontFamily: F.sans }}>
      ...
      <div style={{ maxWidth: 600, margin: '0 auto', padding: `${SP.xxl}px ${SP.xl}px` }}>
        ...
        <div style={{ borderTop: borderLine, paddingTop: SP.xl, marginBottom: SP.xl }}>
          <p style={{ fontSize: FS.sm, color: C.textMuted, lineHeight: 1.6 }}>
            <strong style={{ color: C.textSecondary }}>EU AI Act compliance.</strong> This assessment was made by an AI system. Under Article 22, you have the right to request human review of this decision. Contact <span style={{ color: C.accent }}>info@helloethosfiai.com</span> within 30 days.
          </p>
        </div>
      ...
      <div id="ethofi-pdf" style={{ fontFamily: 'Georgia, "Times New Roman", serif', color: '#111', background: '#fff', padding: '0 8px' }}>
        ...
        <div className="pdf-compliance">
          <strong>EU AI Act Compliance Notice (Article 22).</strong> This credit assessment was produced by an automated AI system (EthosFi AI, model: {score.model_version}). You have the right to request human review of this decision within 30 days of issue. To exercise this right, contact <strong>info@helloethosfiai.com</strong> with your Application ID. You may also request a plain-language explanation of the factors that influenced this score.
        </div>
