            ...
            return (
              <Link
                ...
                style={{
                  ...
                  fontWeight: FW.medium, color: active ? S.accent : S.textSecondary,
              ...
              >
                ...
                {badge !== undefined && badge > 0 && (
                  <span style={{
                    minWidth: 18, height: 18, padding: '0 5px', borderRadius: 9, background: S.surfaceActive,
                    color: S.accent, fontSize: 10, fontWeight: FW.semibold, display: 'flex', alignItems: 'center', justifyContent: 'center',
                  }}>{badge}</span>
                )}
              </Link>
            )
